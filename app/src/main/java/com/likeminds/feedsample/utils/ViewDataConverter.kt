...
import com.likeminds.feedsample.db.models.*
...
import com.likeminds.feedsample.media.model.SingleUriData
...
object ViewDataConverter {
    ...
    fun convertSingleDataUri(singleUriData: SingleUriData): AttachmentViewData {
        ...
        val viewType = when (singleUriData.fileType) {
            IMAGE -> {
                attachmentType = com.likeminds.feedsample.posttypes.model.IMAGE
                ITEM_CREATE_POST_MULTIPLE_MEDIA_IMAGE
            }
            VIDEO -> {
                attachmentType = com.likeminds.feedsample.posttypes.model.VIDEO
                ITEM_CREATE_POST_MULTIPLE_MEDIA_VIDEO
            }
            else -> {
                attachmentType = com.likeminds.feedsample.posttypes.model.DOCUMENT
    ...
    fun convertFileType(fileType: String): Int {
        return when (fileType) {
            IMAGE -> com.likeminds.feedsample.utils.mediauploader.model.IMAGE
            PDF -> com.likeminds.feedsample.utils.mediauploader.model.PDF
            VIDEO -> com.likeminds.feedsample.utils.mediauploader.model.VIDEO
            else -> com.likeminds.feedsample.utils.mediauploader.model.IMAGE
        }
    }
    ...
    fun convertAttachment(
        ...
        val attachmentType = when (singleUriData.fileType) {
            IMAGE -> {
                com.likeminds.feedsample.posttypes.model.IMAGE
            }
            VIDEO -> {
                com.likeminds.feedsample.posttypes.model.VIDEO
            }
            else -> {
                com.likeminds.feedsample.posttypes.model.DOCUMENT
            }
        }
