package com.likeminds.feedsampleapp.post.create.view
...
import com.likeminds.feedsampleapp.databinding.FragmentCreatePostBinding
import com.likeminds.feedsampleapp.media.model.*
import com.likeminds.feedsampleapp.media.util.MediaUtils
import com.likeminds.feedsampleapp.media.view.MediaPickerActivity
import com.likeminds.feedsampleapp.media.view.MediaPickerActivity.Companion.ARG_MEDIA_PICKER_RESULT
import com.likeminds.feedsampleapp.post.create.util.CreatePostListener
import com.likeminds.feedsampleapp.post.create.view.CreatePostActivity.Companion.POST_ATTACHMENTS_LIMIT
import com.likeminds.feedsampleapp.post.create.view.adapter.CreatePostDocumentsAdapter
import com.likeminds.feedsampleapp.post.create.view.adapter.CreatePostMultipleMediaAdapter
import com.likeminds.feedsampleapp.post.create.viewmodel.CreatePostViewModel
import com.likeminds.feedsampleapp.post.edit.viewmodel.HelperViewModel
import com.likeminds.feedsampleapp.posttypes.model.LinkOGTagsViewData
import com.likeminds.feedsampleapp.posttypes.model.UserViewData
import com.likeminds.feedsampleapp.utils.*
import com.likeminds.feedsampleapp.utils.ValueUtils.getUrlIfExist
import com.likeminds.feedsampleapp.utils.ValueUtils.isImageValid
import com.likeminds.feedsampleapp.utils.ViewDataConverter.convertSingleDataUri
...
import com.likeminds.feedsampleapp.utils.link.util.LinkUtil
