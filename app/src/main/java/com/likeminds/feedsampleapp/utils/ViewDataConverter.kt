...
import com.likeminds.feedsampleapp.db.models.*
...
import com.likeminds.feedsampleapp.media.model.SingleUriData
import com.likeminds.feedsampleapp.media.model.VIDEO
...
import com.likeminds.feedsampleapp.utils.mediauploader.utils.AWSKeys
...
import com.likeminds.feedsampleapp.utils.model.ITEM_CREATE_POST_MULTIPLE_MEDIA_VIDEO
...
object ViewDataConverter {
    ...
    fun convertSingleDataUri(singleUriData: SingleUriData): AttachmentViewData {
        ...
        val viewType = when (singleUriData.fileType) {
            IMAGE -> {
                attachmentType = com.likeminds.feedsampleapp.posttypes.model.IMAGE
                ITEM_CREATE_POST_MULTIPLE_MEDIA_IMAGE
            }
            VIDEO -> {
                attachmentType = com.likeminds.feedsampleapp.posttypes.model.VIDEO
                ITEM_CREATE_POST_MULTIPLE_MEDIA_VIDEO
            }
            else -> {
                attachmentType = com.likeminds.feedsampleapp.posttypes.model.DOCUMENT
    ...
    fun convertFileType(fileType: String): Int {
        return when (fileType) {
            IMAGE -> com.likeminds.feedsampleapp.utils.mediauploader.model.IMAGE
            PDF -> com.likeminds.feedsampleapp.utils.mediauploader.model.PDF
            VIDEO -> com.likeminds.feedsampleapp.utils.mediauploader.model.VIDEO
            else -> com.likeminds.feedsampleapp.utils.mediauploader.model.IMAGE
        }
    }
    ...
    fun convertAttachment(
        ...
        val attachmentType = when (singleUriData.fileType) {
            IMAGE -> {
                com.likeminds.feedsampleapp.posttypes.model.IMAGE
            }
            VIDEO -> {
                com.likeminds.feedsampleapp.posttypes.model.VIDEO
            }
            else -> {
                com.likeminds.feedsampleapp.posttypes.model.DOCUMENT
            }
        }
